...
namespace QLNS_LinQ
{
    public partial class FormThanNhan : Form
    {
        ...
        void LoadData()
        {
            try
            {
                dgvTHANNHAN.DataSource = dbTN.LayThanNhan();
                ...
                dgvTHANNHAN.Columns[dgvTHANNHAN.Columns.Count - 1].Visible = false;
        ...
        private void FormThanNhan_Load(object sender, EventArgs e)
        {
            LoadData();
        }
