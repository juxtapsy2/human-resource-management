namespace QLNS_ADO.NET
{
    partial class FormReportLuong
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lUONGTableAdapter = new QLNS_ADO.NET.DataSet_QLNSTableAdapters.LUONGTableAdapter();
            ...
            reportDataSource1.Value = this.lUONGBindingSource1;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "QLNS_ADO.NET.Reports.ReportLuong.rdlc";
