...
namespace QLNS_ADO.NET
{
    public partial class FormReportTongQuanNV : Form
    {
        ...
        {
            this.tONGQUANNVTableAdapter.FillByMaNV(this.dataSet_QLNS.TONGQUANNV, this.txtTongQuanMaNV.Text);
        ...
        {
            FormThongKeNhanLuc formThongKeNhanLuc = new FormThongKeNhanLuc();
            formThongKeNhanLuc.ShowDialog();
        }
    }
}
